const Map<String, String> zh_CN = {
  ...
  "registerWithUser": "用户名注册",
  "loginWithAutoRegister": "设备自动注册登录",
  "loginWithAutoRegisterHint": "是否根据手机设备号注册账号并登录",
  "phoneNumber": "手机号",
  ...
  "and": "和",
  "privacyPolicy": "《隐私政策》",
  "alertDialogAgreementTitle": "用户协议及隐私政策",
  "alertDialogAgreementContent": "为了更好地保障您的合法权益，请您阅读并同意以下协议",
  "noAccountYet": "还没有账号？",
  "loginNow": "立即登录",
  "registerNow": "立即注册",
